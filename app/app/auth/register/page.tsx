...
export default function SignUpPage() {
  ...
  useEffect(() => {
    if (persistedError && isClient) {
      console.log('Register page found persisted error, showing form')
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span>{isPortuguese ? 'Cadastrar com email' : 'Sign up with email'}</span>
            </button>
            ...
            >
              ...
              <span>{isPortuguese ? 'Cadastrar com Google' : 'Sign up with Google'}</span>
            </button>
            ...
            >
              ...
              <span>{isPortuguese ? 'Cadastrar com Apple' : 'Sign up with Apple'}</span>
            </button>
          </div>
          ...
          <p className="text-center text-gray-400 mt-8">
            ...
            <Link href={isPortuguese ? "/auth/login?lang=pt" : "/auth/login"} className="text-white font-bold hover:underline">
