  ...
  return (
    <section className="w-full min-h-[60vh] flex items-center pt-20 sm:pt-24 lg:pt-28">
      <div className="container mx-auto px-4 flex flex-col items-center text-center">
        {/* Hero Title - Fluid typography with clamp() for gradual scaling */}
        ...
        {/* Hero Description - Fluid typography with clamp() for gradual scaling */}
        ...
        {/* CTA Button - Desktop-first responsive sizing with smooth transitions */}
        <button 
